...
class DbConverters {
    ...
    @TypeConverter
    fun fromSessionPlannerState(value: SessionPlannerState): String = value.name

    @TypeConverter
    fun toSessionPlannerState(value: String): SessionPlannerState = SessionPlannerState.valueOf(value)
